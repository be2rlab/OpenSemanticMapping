...
# data paths
SCENE_DIR="/data/Datasets/openmask3d_datasets/room0"
SCENE_POSE_DIR="${SCENE_DIR}/pose"
SCENE_INTRINSIC_PATH="${SCENE_DIR}/intrinsic/intrinsic_color.txt"
SCENE_INTRINSIC_RESOLUTION="[680,1200]" # change if your intrinsics are based on another resolution
SCENE_PLY_PATH="${SCENE_DIR}/room0_mesh.ply"
...
DEPTH_SCALE=6553.5
# model ckpt paths
MASK_MODULE_CKPT_PATH="/assets/openmask3d/scannet200_model.ckpt"
SAM_CKPT_PATH="/assets/openmask3d/sam_vit_h_4b8939.pth"
# output directories to save masks and mask features
EXPERIMENT_NAME="experiment"
OUTPUT_DIRECTORY="/export/output/openmask3d"
